...
<template>
  <div class="custom-cursor" ref="cursorRef">
    ...
    <div class="custom-cursor__corner custom-cursor__corner--tl"></div>
    <div class="custom-cursor__corner custom-cursor__corner--tr"></div>
    <div class="custom-cursor__corner custom-cursor__corner--br"></div>
    <div class="custom-cursor__corner custom-cursor__corner--bl"></div>
  </div>
</template>
...
.custom-cursor__corner--tl {
  border-right: 0;
  border-bottom: 0;
  transform: translate(-150%, -150%);
}

.custom-cursor__corner--tr {
  border-bottom: 0;
  border-left: 0;
  transform: translate(50%, -150%);
}

.custom-cursor__corner--br {
  border-top: 0;
  border-left: 0;
  transform: translate(50%, 50%);
}

.custom-cursor__corner--bl {
  border-top: 0;
  border-right: 0;
